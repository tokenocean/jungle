      ...
      <div class="guide">
        ...
        <div class="item" id="liquid">
          ...
          <img
            ...
            alt="Getting the address to fund a wallet"
          />
          <p>
        ...
        <div class="item" id="btc-lightning">
          ...
          <img
            ...
            alt="Getting a Lightning address"
          />
        </div>
        <div class="item" id="upload-artwork-and-mint-nft">
          ...
          <img
            ...
            alt="Profile page link on the top-right"
          />
          <img
            class="guide-image"
            src="/guide/image4.png"
            alt="Where to make a new artwork"
          />
          <p>
          ...
          <img
            ...
            alt="Where to upload your artwork"
          />
          <img
            class="guide-image"
            src="/guide/image1.png"
            alt="A successfully uploaded artwork"
          />
          ...
          <img
            ...
            alt="Artwork with upload settings"
          />
          <p>
          ...
          <img
            ...
            alt="Artwork successfully created"
          />
          <p>
          ...
          <img
            ...
            alt="Wallet now contains 2 assets"
          />
          <img
            class="guide-image"
            src="/guide/image28.png"
            alt="Wallet contains 'happiness' and 0.00004767 L-BTC"
          />
        </div>
        <div class="item" id="list-artwork">
          ...
          <img
            ...
            alt="One artwork is unlisted"
          />
          <img
            class="guide-image"
            src="/guide/image26.png"
            alt="Button to list an artwork is on the left"
          />
          <p>
        ...
        <div class="item" id="simple-listing">
          ...
          <img
            ...
            alt="Submitting a listed artwork"
          />
          <img
            class="guide-image"
            src="/guide/image13.png"
            alt="Art work 'Hippocampus' is listed"
          />
          <img
            class="guide-image"
            src="/guide/image12.png"
            alt="History of art work 'Hippocampus'"
          />
          <p>
        ...
        <div class="item" id="auction">
          ...
          <img
            ...
            alt="Select this checkbox to create an auction"
          />
        ...
        <div class="item" id="what-to-expect-after-listing">
          ...
          <img
            ...
            alt="An artwork with a bid of 0.000025 L-BTC"
          />
          <img
            class="guide-image"
            src="/guide/image20.png"
            alt="The offer of 0.000025 L-BTC for the artwork"
          />
          <img
            class="guide-image"
            src="/guide/image32.png"
            alt="Bid accepted, art ownership transferred"
          />
          <p>
        ...
        <div class="item" id="edit-profile">
          ...
          <img
            ...
            alt="Edit Profile button on the left"
          />
